export default function Resume() {
  const fileId = "1knhLkARLfRNbX2qeOEFyQJp_DorqC-y3";
  const resumeEmbed = `https://drive.google.com/file/d/${fileId}/preview`;
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        {/* Header */}
        <div className="mb-8">
          <p className="text-teal-300 tracking-[0.3em] uppercase text-xs mb-3 font-mono">
            Documents
          </p>
